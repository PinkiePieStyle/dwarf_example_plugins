...
class DwarfPlugin:
    ...
    plugin_info = {
        'name': 'SimpleJs',
        'description': 'Simple script example',
        'version': '1.0.0',
        'author': 'Dwarf',
    ...
    def __init__(self, dwarf_core: DwarfCore):
        self._dwarf_api = dwarf_core.dwarf_api

    # ************************************************************************
    # **************************** Functions *********************************
    # ************************************************************************
    def on_script_loaded(self, loaded: bool):
        # callback from pluginmanager after js is loaded
        if loaded:
            self._dwarf_api.evaluateFunction('scriptLoaded()')
